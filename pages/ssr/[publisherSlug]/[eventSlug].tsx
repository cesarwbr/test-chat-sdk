...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  // const [dataCSS, dataHTML, dataScript] = await Promise.all([
  //   fetch(`http://localhost:3000/ssr/css/${publisherSlug}/${eventSlug}`, {
  //     headers: {
  //       "user-agent": context.req.headers["user-agent"],
  //     },
  //   }),
  //   fetch(`http://localhost:3000/ssr/html/${publisherSlug}/${eventSlug}`, {
  //     headers: {
  //       "user-agent": context.req.headers["user-agent"],
  //     },
  //   }),
  //   fetch(`http://localhost:3000/ssr/script/${publisherSlug}/${eventSlug}`, {
  //     headers: {
  //       "user-agent": context.req.headers["user-agent"],
  //     },
  //   }),
  ...
  // const css = await dataCSS.text();
  // const html = await dataHTML.text();
